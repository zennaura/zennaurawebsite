...
const ViewAllOrders = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 md:flex-row">
      <div className="w-full md:w-64 lg:w-72 xl:w-60 bg-white shadow-md md:h-screen md:sticky md:top-0 z-10">
        <AdminNavbar />
      </div>
                        ...
                        {order.orderItems?.map((item, index) => (
                          <div key={index} className="flex items-start !p-3 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
                            ...
                            <div className="!ml-3 flex-1">
                              <div className="font-medium text-gray-800">{item.name || 'Unknown Product'}</div>
