  ...
  return (
    <div div className="reviews-page">
      ...
      <div className="reviews-page-container">
        {isMobile?(<div className="reviews-page-summary" style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",margin:"auto",width:"95vw"}}>
            <p className="text-4xl font-bold">{averageRating}</p>
          <div className="total-reviews" style={{width:"95vw",display:"flex",justifyContent:"center",alignItems:"center"}}>
            ...
            {averageRating % 1 >= 0.75 && <FaStar className="reviews-star" />}
        ...
        </div>):(<div className="reviews-page-summary">
          ...
          <div className="reviews-page-rating-bars">
            <div className="reviews-page-stars1">
              ...
              <span className="reviews-page-processbar">
                <span
                  className="reviews-page-processbar-fill"
                  style={{
                    width: starPercentages[0] ? `${starPercentages[0]}%` : "1%",
            ...
            <div className="reviews-page-stars2">
              ...
              <span className="reviews-page-processbar">
                <span
                  className="reviews-page-processbar-fill"
                  style={{
                    width: starPercentages[1] ? `${starPercentages[1]}%` : "1%",
                    backgroundColor: "rgb(62, 242, 62)",
                  }}
                ></span>
              </span>
              {starCounts[1]}
            ...
            <div className="reviews-page-stars3">
              ...
              <span className="reviews-page-processbar">
                <span
                  className="reviews-page-processbar-fill"
                  style={{
                    width: starPercentages[2] ? `${starPercentages[2]}%` : "1%",
            ...
            <div className="reviews-page-stars4">
              ...
              <span className="reviews-page-processbar">
                <span
                  className="reviews-page-processbar-fill"
                  style={{
                    width: starPercentages[3] ? `${starPercentages[3]}%` : "1%",
                    backgroundColor: "red",
                  }}
                ></span>
              </span>
            ...
            <div className="reviews-page-stars5">
              ...
              <span className="reviews-page-processbar">
                <span
                  className="reviews-page-processbar-fill"
                  style={{
                    width: starPercentages[4] ? `${starPercentages[4]}%` : "1%",
        ...
        {reviews.map((review, idx) => (
          <div className="reviews-page-card" key={review._id || idx}>
            ...
            <div className="reviews-page-user">
              <img
                src={
                  review.mediaUrls && review.mediaUrls[0]
                    ? review.mediaUrls[0]
                    : ""
                }
                alt=""
                className="reviews-page-user-image"
              />
              <h2 className="reviews-page-user-name">
