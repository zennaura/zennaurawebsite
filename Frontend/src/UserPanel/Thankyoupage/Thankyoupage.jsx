    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center p-6 bg-white font-sans">
        <div className="max-w-md w-full text-center p-8 bg-white rounded-lg shadow-sm">
          <div className="mb-8">
            <h1 className="text-sm font-normal text-gray-800 mb-2">Zenn Aura/CHECKOUT</h1>
          </div>
          ...
          <button className="bg-[#4A001F] text-white px-8 py-3 rounded-md font-medium mb-6 hover:bg-[#3b001a] transition-colors" onClick={keepshoping}>
            Keep Shopping
          </button>
