...
//         // Create flattened array with all product variants
//         const flattened = productsData.flatMap((product) =>
//           product.variants.map((variant, index) => ({
//             id: `${product._id}-${index}`,
//             productId: product._id, // Store the original product ID separately
//             data: {
//               _id: product._id,
//               title: product.title,
//               description: product.description,
...
//         // Store all flattened products for variant lookup
//         setAllProducts(flattened);

//         // Filter only featured products for display
//         const featuredOnly = flattened.filter((product) => product.data.featureProduct);
...
//   const handleClick = (product) => {
//     // Get the base product ID (without variant index)
//     const productId = product.productId;

//     // Find all variants of this product from the complete products list
//     const productVariants = allProducts
//       .filter((p) => p.productId === productId)
//       .map((variant) => ({
...
//         // Add any other variant-specific fields you need
//       }));

//     console.log("Clicked product:", product);
//     console.log("All variants for this product:", productVariants);
//     console.log("Total variants found:", productVariants.length);

//     navigate(`/productdetails/${product.id}`, {
//       state: {
//         ...product.data,
//         allVariants: productVariants,
//         selectedVariantId: product.id, // Pass the current variant ID
//       },
//     });
//   };
